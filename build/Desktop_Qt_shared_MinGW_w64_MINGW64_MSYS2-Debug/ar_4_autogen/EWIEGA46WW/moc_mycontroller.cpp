...
namespace {
struct qt_meta_tag_ZN12MyControllerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12MyControllerE = QtMocHelpers::stringData(
    "MyController"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12MyControllerE[] = {
...
Q_CONSTINIT const QMetaObject MyController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12MyControllerE.offsetsAndSizes,
    qt_meta_data_ZN12MyControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12MyControllerE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12MyControllerE.stringdata0))
